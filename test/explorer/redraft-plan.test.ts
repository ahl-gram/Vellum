...
// Sub 9 (#170): the redraft dries in ONLY the names the finer sheet labels that the outgoing composition did not; persisting names must never re-animate. Measured ground truth at seed 42, band-1 window centred 0.5 (2026-07-19): the world labels 25 of 26 settlements, the region newly labels exactly Lokai (village).
