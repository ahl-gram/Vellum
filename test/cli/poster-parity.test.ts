...
// The covenant is RECIPE-level, not byte-level: the Print Room proof defaults its legend ON, a structural SVG group, so a poster is deliberately NOT full-SVG identical to a plain chart; the option-carry is the print-room e2e's.
