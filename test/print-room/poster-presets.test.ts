...
// #217 Part 1: the chart plate. It lives OUTSIDE POSTER_PRESETS on purpose: the clamp
// envelope must stay [Desk, Grand] (clampPosterWidth would raise 1500 to 2400, so the
// order path uses CHART_PRESET.width directly), and the poster roster tests above keep
// pinning exactly three posters.
