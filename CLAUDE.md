...
`specs/flake-record.md` is the dated ledger of every CI red believed to be a flake, one row per
failure, which is what you consult instead of pressing re-run (#578).
