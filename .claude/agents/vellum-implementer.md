...
4. Whatever the work touches: `specs/rulebook.md` before anything that can move a chart, the golden, a seed or the order of work; `specs/ui-design.md` before an appearance; `specs/explorer-doctrine.md` before the Explorer, a region sheet, the voyage, or a chart camera or gesture; `specs/settle-doctrine.md` before an e2e wait, settle or CDP probe.
