...
- **Owed companion reports.** New or strengthened guards owe a guard-prover run; presentation work owes a plate-reader run. If the PR and its issue show neither report, flag the omission. Do not perform those jobs yourself: you cannot mutate and you do not render, you flag.
