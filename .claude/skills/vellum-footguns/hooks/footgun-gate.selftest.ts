...
const FIXTURES: Fixture[] = [
  ...
  // The backreference is what ties the escaped character to the DELIMITER: here the pipe delimits and a plus is escaped, which real perl leaves alone, so a class-only regex would refuse a correct command.
