...
- *Synthetic input over a control nobody can press.* #542: `element.click()` ignores
  ...
  which #578 settled and `flake-record.md` beside this file now records; it was the drawer's slide
  not yet painted, leaving all six controls below the viewport.
