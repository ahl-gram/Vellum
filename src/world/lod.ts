...
export type SettleDecision =
  ...
  | { readonly action: "region"; readonly band: number; readonly window: UvWindow; readonly centre: UvCamera };
...
export function decideSettle(state: {
  ...
  return { action: "region", band, window, centre: { cx, cy, k: state.camera.k } };
}
