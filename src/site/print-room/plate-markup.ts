// The bound atlas's plate markup: the string-in/string-out half of bound-atlas.ts; the host mints the blob URL and holds it for revocation, then hands the href in.
