// The Print Room's slip contents: the atlas's index, string in and string out like plate-markup.ts. The host mints the blob URLs and hands the refs in; a null atlas is the unbound state.
