...
/** Lay a sheet on the table. Refused whole at the cap, which the drawer says in its own voice. */
...
/** Take one cutting off by its seat; an unseated index leaves the table whole. */
...
/** How many more the table will hold, for the count at the drawer's head. */
