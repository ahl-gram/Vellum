// The host half of the off-thread travel order: holds the one answer the living-chart's session builder reads synchronously; single-entry, like ./world-cache.ts.
