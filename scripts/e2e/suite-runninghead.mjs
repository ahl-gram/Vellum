...
const FOLIO = ["/seed-of-the-day/", "/faq/", "/glossary/", "/explorer/", "/reading-room/", "/print-room/", "/prospect/", "/ribbon/"];
const CHART = ["/seed-of-the-day/", "/explorer/", "/reading-room/", "/print-room/", "/prospect/", "/ribbon/"];
const FOLIO_HEAD = {
  ...ROOM_HEAD,
