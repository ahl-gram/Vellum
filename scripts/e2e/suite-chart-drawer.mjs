...
export async function run(ctx) {
  ...
  // One gesture can move two panels: the tab press both slides the drawer up and folds the slip, and a read taken when only one has arrived is the read this issue is about.
